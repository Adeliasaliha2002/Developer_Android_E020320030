package id.ac.poliban.vbmi.adeliaputrisaliha.roomwordssampledelete;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.vbmi.adeliaputrisaliha.roomwordssampledelete.REPLY";
