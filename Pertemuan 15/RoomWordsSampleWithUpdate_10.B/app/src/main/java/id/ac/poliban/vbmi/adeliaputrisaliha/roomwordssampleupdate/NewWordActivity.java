package id.ac.poliban.vbmi.adeliaputrisaliha.roomwordssampleupdate;


import static id.ac.poliban.vbmi.adeliaputrisaliha.roomwordssampleupdate.MainActivity.EXTRA_DATA_ID;
import static id.ac.poliban.vbmi.adeliaputrisaliha.roomwordssampleupdate.MainActivity.EXTRA_DATA_UPDATE_WORD;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.vbmi.adeliaputrisaliha.roomwordssampleupdate.REPLY";
    public static final String EXTRA_REPLY_ID = "id.ac.poliban.vbmi.adeliaputrisaliha.roomwordssampleupdate.REPLY_ID";
