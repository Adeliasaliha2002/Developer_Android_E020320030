package id.ac.poliban.vbmi.adeliaputrisaliha.homework_10b;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.vbmi.adeliaputrisaliha.homework_10b";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Data Storage Types Adel");
