package id.ac.poliban.vbmi.adeliaputrisaliha.recyclerviewespresso_061;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("RecyclerViewEspressoTest Adel");
