package id.ac.poliban.vbmi.adeliaputrisaliha030.powerreceiverhw_073;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_RANDOM_NUMBER = "id.ac.poliban.vbmi.adeliaputrisaliha030.powerreceiverhw_073.RANDOM_NUMBER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("PowerReceiver 7.3 Adel");
